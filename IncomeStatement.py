...
class IncomeStatement(BaseAPI):
    _property="IncomeStatement"
    ...
    def ppt_output(cls,query:dict,style:dict,pr):
        ...
        required_items=["totalRevenue","costOfRevenue","grossProfit","researchDevelopment","sellingGeneralAdministrative","interestExpense"
                         ,"otherOperatingExpenses","totalOperatingExpenses","operatingIncome","ebit","totalOtherIncomeExpenseNet","incomeBeforeTax",
                          "incomeTaxExpense","netIncomeFromContinuingOps","discontinuedOperations","minorityInterest","netIncome","netIncomeApplicableToCommonShares"]
         # Constants for ppt
        ...
        slide=pr.slides.add_slide(layout)
         # # Heading
        heading=Heading(HEADING_FONT_SIZE,THEME_COLOR,HEADING_FONT,(Inches(0.2),Inches(0),Inches(SLIDE_WIDTH/2),Inches(0.5)),"Income Statement",slide)
        ...
        table=Table(structured_data,(4,1.5,12,len(structured_data["indexes"])*0.2),column_width,slide)
        table.create()
